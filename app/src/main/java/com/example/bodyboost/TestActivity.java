...
public class TestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent alarmIntent = new Intent(TestActivity.this, AlarmReceiver.class);
        pendingIntent = PendingIntent.getBroadcast(TestActivity.this, ALARM_REQUEST_CODE, alarmIntent, PendingIntent.FLAG_IMMUTABLE);
        ...
        findViewById(R.id.start_alarm_button).setOnClickListener(v -> {
    ...
    public void stopAlarmManager() {
        ...
        stopService(new Intent(TestActivity.this, AlarmSoundService.class));
